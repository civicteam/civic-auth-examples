...
Error: locator.waitFor: Error: strict mode violation: locator('#civic-auth-iframe') resolved to 2 elements:
    1) <iframe scrolling="no" frameborder="0" seamless="seamless" id="civic-auth-iframe" allowfullscreen="true" data-testid="civic-auth-iframe-with-resizer" allow="camera; screen-wake-lock; publickey-credentials-get *; publickey-credentials-create *" src="http://localhost:3000/api/auth/login?state=eyJ1dWlkIjoiOTA0YjRmNTEtYTdmOS00YjRlLThhNzktNTMxMjM5NGY2MDUxIiwiZGlzcGxheU1vZGUiOiJpZnJhbWUiLCJpZnJhbWVEaXNwbGF5TW9kZSI6Im1vZGFsIiwiZnJhbWV3b3JrIjoibmV4dGpzIiwic2RrVmVyc2lvbiI6IkBjaXZpYy9hdXRoOjAuMTAuMC1iZXRhLjcifQ…></iframe> aka locator('[data-testid="civic-auth-iframe-with-resizer"]').first()
    2) <iframe scrolling="no" frameborder="0" seamless="seamless" id="civic-auth-iframe" allowfullscreen="true" data-testid="civic-auth-iframe-with-resizer" allow="camera; screen-wake-lock; publickey-credentials-get *; publickey-credentials-create *" src="http://localhost:3000/api/auth/login?state=eyJ1dWlkIjoiYmY5Nzc3MzQtMzY5Mi00ZmFkLWFmOWEtMDg4ZTZiYTM4YjY5IiwiZGlzcGxheU1vZGUiOiJpZnJhbWUiLCJpZnJhbWVEaXNwbGF5TW9kZSI6Im1vZGFsIiwiZnJhbWV3b3JrIjoibmV4dGpzIiwic2RrVmVyc2lvbiI6IkBjaXZpYy9hdXRoOjAuMTAuMC1iZXRhLjcifQ…></iframe> aka locator('[data-testid="civic-auth-iframe-with-resizer"]').nth(1)

Call log:
  - waiting for locator('#civic-auth-iframe').contentFrame().locator('body') to be visible
    2 × locator resolved to hidden <body></body>

    at /__w/civic-auth-examples/civic-auth-examples/packages/e2e/playwright/tests/civic-auth/nextjs-login.spec.ts:34:33
```

...
- Location: /__w/civic-auth-examples/civic-auth-examples/packages/e2e/playwright/tests/civic-auth/loginSuccessUrl/fastify-login.spec.ts:10:7
...
Call log:
  ...
  - waiting for locator(':root')
    7 × locator resolved to <html lang="en" data-sentry-component="RootLayout" data-sentry-source-file="layout.tsx" class="__variable_5722f4 __variable_bc3585">…</html>
      - unexpected value "https://auth-dev.civic.com/login?state=eyJ1dWlkIjoiYTI4ZGUxZWItMTcyNC00OTk1LThmODQtN2YzMGFlZTRkNWFlIiwiZnJhbWV3b3JrIjoic2VydmVyIiwic2RrVmVyc2lvbiI6IkBjaXZpYy9hdXRoOjAuMTAuMC1iZXRhLjcifQ%3D%3D&client_id=demo-client-1&source_system_id=GyIwlNIAPsQwwu8yUgkP0kNLLsiN4bFneBoLcQFB07Y&scope=openid+profile+email+forwardedTokens+offline_access&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fcallback&flow_id=oauth-login-96c85197-ec44-4d87-bae4-1706c24caedb"
    - waiting for" http://localhost:3000/auth/callback?code=vSAAW348TvKouaxeQrlptTqukHL0Jvc2Hq-rTy2PtEj&state=eyJ1dWlkIjoiYTI4ZGUxZWItMTcyNC00OTk1LThmODQtN2YzMGFlZTRkNWFlIiwiZnJhbWV3b3JrIjoic2VydmVyIiwic2RrVmVyc2lvbiI6…" navigation to finish...
    - navigated to "http://localhost:3000/customSuccessUrl"
    16 × locator resolved to <html>…</html>
       - unexpected value "http://localhost:3000/customSuccessUrl"

    at /__w/civic-auth-examples/civic-auth-examples/packages/e2e/playwright/tests/civic-auth/loginSuccessUrl/fastify-login.spec.ts:66:24
```

# Page snapshot

```yaml
- text: "{\"message\":\"Route GET:/customSuccessUrl not found\",\"error\":\"Not Found\",\"statusCode\":404}"
```

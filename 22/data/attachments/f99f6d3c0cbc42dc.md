...
- Location: /__w/civic-auth-examples/civic-auth-examples/packages/e2e/playwright/tests/civic-auth/fastify-login.spec.ts:10:7
...
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
Call log:
  - <launching> /ms-playwright/firefox-1482/firefox/firefox -no-remote -headless -profile /tmp/playwright_firefoxdev_profile-FXdCBe -juggler-pipe -silent
  - <launched> pid=933
  - [pid=933][err] Running Nightly as root in a regular user's session is not supported.  ($HOME is /github/home which is owned by uid 1001.)
  - [pid=933] <process did exit: exitCode=1, signal=null>
  - [pid=933] starting temporary directories cleanup
...
```ts
   ...
   8 |     await allure.feature('Fastify Login');
   9 |   });

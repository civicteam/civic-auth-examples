...
- Location: /__w/civic-auth-examples/civic-auth-examples/packages/e2e/playwright/tests/civic-auth/loginSuccessUrl/hono-login.spec.ts:10:7
...
Received string:  "https://auth-dev.civic.com/login?state=eyJ1dWlkIjoiYmFkYzZjZTEtYmQ1OC00NmI1LWJjZmUtYTcxZWQ0NzcwM2MyIiwiZnJhbWV3b3JrIjoic2VydmVyIiwic2RrVmVyc2lvbiI6IkBjaXZpYy9hdXRoOjAuMTAuMC1iZXRhLjcifQ%3D%3D&client_id=demo-client-1&source_system_id=sphun_nRLgcQ8E8Onzth61R2Z6vSnn70AiqgSYJ0WZN&scope=openid+profile+email+forwardedTokens+offline_access&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fcallback&flow_id=oauth-login-fb9221ec-6c09-448b-a39d-8826210c8913"
Call log:
  ...
  - waiting for locator(':root')
    24 × locator resolved to <html lang="en" data-sentry-component="RootLayout" data-sentry-source-file="layout.tsx" class="__variable_5722f4 __variable_bc3585">…</html>
       - unexpected value "https://auth-dev.civic.com/login?state=eyJ1dWlkIjoiYmFkYzZjZTEtYmQ1OC00NmI1LWJjZmUtYTcxZWQ0NzcwM2MyIiwiZnJhbWV3b3JrIjoic2VydmVyIiwic2RrVmVyc2lvbiI6IkBjaXZpYy9hdXRoOjAuMTAuMC1iZXRhLjcifQ%3D%3D&client_id=demo-client-1&source_system_id=sphun_nRLgcQ8E8Onzth61R2Z6vSnn70AiqgSYJ0WZN&scope=openid+profile+email+forwardedTokens+offline_access&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fcallback&flow_id=oauth-login-fb9221ec-6c09-448b-a39d-8826210c8913"

    at /__w/civic-auth-examples/civic-auth-examples/packages/e2e/playwright/tests/civic-auth/loginSuccessUrl/hono-login.spec.ts:66:24
```
...
- main:
  ...
  - paragraph: d2d8c7de-079b-40a2-9812-d3a5cc75691f
...
```ts
   ...
   8 |     await allure.feature('Hono Login (LoginSuccessUrl)');
   9 |   });

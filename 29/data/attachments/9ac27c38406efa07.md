...
Call log:
  - waiting for locator('#civic-auth-iframe') to be hidden
    124 × locator resolved to visible <iframe scrolling="no" frameborder="0" seamless="seamless" id="civic-auth-iframe" allowfullscreen="true" data-testid="civic-auth-iframe-with-resizer" allow="camera; screen-wake-lock; publickey-credentials-get *; publickey-credentials-create *" src="http://localhost:3000/demo/api/auth/login?state=eyJ1dWlkIjoiMjIxMjE3OTItNjBiZi00MmQ4LWJjMWMtNjU1MTZhZDU0NzdmIiwiZGlzcGxheU1vZGUiOiJpZnJhbWUiLCJpZnJhbWVEaXNwbGF5TW9kZSI6Im1vZGFsIiwiZnJhbWV3b3JrIjoibmV4dGpzIiwic2RrVmVyc2lvbiI6IkBjaXZpYy9hdXRoOjAuMTAuMC1iZXRhL…></iframe>

    at /__w/civic-auth-examples/civic-auth-examples/packages/e2e/playwright/tests/civic-auth/basePath/nextjs-login.spec.ts:68:16
```

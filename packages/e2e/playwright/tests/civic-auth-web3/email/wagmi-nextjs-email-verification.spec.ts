...
test.describe('Civic Auth Applications', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await allure.feature('Wagmi NextJS Email Verification');
  });

  test('should complete email verification flow', async ({ page, browserName }) => {
    await allure.story('Wagmi NextJS Email Code Verification Flow');
    ...
    await allure.step('Navigate to Wagmi NextJS app home page', async () => {

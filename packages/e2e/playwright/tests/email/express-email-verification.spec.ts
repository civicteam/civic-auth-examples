...
test.describe('Express Email Verification Tests', () => {
  ...
  test('should complete email verification flow and redirect to hello page', async ({ page, browserName }) => {
    await allure.story('Express Email Code Verification Flow');
    await allure.severity('critical');
    await allure.tag('express-email-verification');
    ...
    await allure.step('Navigate to Express app home page', async () => {
  ...
  test('should complete email verification flow with actual email', async ({ page, browserName }) => {
    await allure.story('Express Email Code Verification Flow with Real Email');
    await allure.severity('critical');
    await allure.tag('express-email-verification-real');
